                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6">
                        <div className="footer-contact">
                            ...
                            <a href="tel:+91-9392877127"><p><i className="fa fa-phone"></i>+91-9392877127</p></a>
                            <a href="mailto:subbudusanapudi@gmail.com"><p><i className="fa fa-envelope"></i>subbudusanapudi@gmail.com</p></a>
            ...
            <div className="container copyright">
                <div className="row">
                    <div className="col-md-6">
                        <p>&copy; <a href="#">THE CLARITY DONATION </a> | 2024, All Right Reserved.</p>
                    </div>
                    {/* <div className="col-md-6">
