...
export default function Donate() {
    ...
    const fetchRecentLogin = async (auth, mail) => {
        var options = {
            method: 'GET',
            url: 'http://localhost:8080/api/v1/registration/getLogs?email=' + mail,
            headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isLogin) {
            ...
            var options = {
                method: 'POST',
                url: 'http://localhost:8080/api/v1/donate/pay',
                headers: {
            ...
            try {
                ...
                var get_razKey = {
                    method: 'GET',
                    url: 'http://localhost:8080/api/v1/donate',
                    headers: {
                        Authorization: `Basic ${password}`,
                        'Content-Type': 'application/json'
                    },
                ...
                const options = {
                    ...
                    handler: async function (response) {
                        ...
                        var options = {
                            method: 'POST',
                            url: 'http://localhost:8080/api/v1/donate/pay/verify',
                            headers: {
                                Authorization: `Basic ${password}`,
                                'Content-Type': 'application/json'
                            },
    ...
    const handleEmail = async () => {
        ...
        if (regex.test(String(email).toLowerCase())) {
            const url = "http://localhost:8080/api/v1/registration?email=" + String(email).toLowerCase();
            await axios.get(url)
                .then(response => {
    ...
    const handleLogin = async () => {
        const options = {
            method: 'POST',
            url: 'http://localhost:8080/api/v1/registration/auth',
        ...
        <>
            ...
            {showPopup ? <div className='popUp'>
                <div className='popup-content'>
                    ...
                    <div className="form">
                        <input type="email" name="mail" id="mail" onChange={(e) => setEmail(e.target.value)} value={email} placeholder='Enter your email address' autoComplete='true' readOnly={showLogin} required />
