...
function Admin() {
    ...
    const adminLogin = async () => {
        MySwal.fire({
            ...
            preConfirm: async () => {
                try {
                    const url = `http://localhost:8080/api/v1/registration/auth`;
    ...
    const fetchDonations = async (auth1) => {
        var options = {
            method: 'GET',
            url: 'http://localhost:8080/api/v1/search/allDonations',
            headers: {
    ...
    const fetchUserInfo = async (mail) => {
        var options = {
            method: 'GET',
            url: 'http://localhost:8080/api/v1/search/donations?email=' + mail,
            headers: {
